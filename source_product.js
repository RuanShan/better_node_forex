...
//  http://www.baring.cn/quo/bin/quotation.dll?fields=Price,LastSettle,&symbols=CRHKG,CRTWGD,CRXAG,CRXAP,CRXAU,CRXPD
var symbols = [ 'CRXAU','CRXAG','CRXAP','NYCON0','CXSLN2' ,'SQCOS0']

var url = "http://www.baring.cn/quo/bin/quotation.dll?fields=Price,LastSettle,Open,High,Low,Close,&symbols=CRXAU,CRXAG,CRXAP,NYCON0,CXSLN2,SQCOS0,"
headers = {
